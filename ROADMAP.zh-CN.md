...
- Phase 4.2A–4.2C：内嵌文件 GUI、本地二维码 PNG、受控浏览器上传、当前用户级 Windows 开机启动/Explorer 同步、原生托盘、完成事件和明确接收确认。
...
- **Phase 4 / `v0.4.x` — 局域网协作：** 文件传输、内嵌 GUI 与 Windows 外壳基础已实现；URL 推送、图片投递、原生宿主窗口、
  接收确认、组合上下文任务和更完整的传输状态仍待完成。
