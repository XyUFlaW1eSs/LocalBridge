...
- **Phase 4 / `v0.4.x` — 局域网协作：** 文件传输基础和 Sprint 4.2A 已实现（持久化分享/接收、内嵌 GUI、浏览器安全 multipart
  分享、真实二维码 PNG、HTTP Range 和可恢复 Content-Range 上传）；URL 推送、图片投递、通知、Windows 原生效果、组合上下文任务
  和更完整的传输状态仍待完成。
